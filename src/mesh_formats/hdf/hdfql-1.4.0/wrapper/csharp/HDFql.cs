...
public class HDFql {
		...
		private static Variable []variableList = new Variable[]{null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null};
		...
		private class Variable
		{
			...
			public Variable(object variable, int type)
			{
				this.variable = variable;
				this.handle = GCHandle.Alloc(this.variable, GCHandleType.Pinned);
				this.type = type;
				this.address = (int) this.handle.AddrOfPinnedObject();
			}
		}
		...
		public static int VariableRegister(object variable)
		{
			...
			size = ((Array) variable).Length;
			// INFO: no need to test for build-in types since in C sharp primitive types (e.g. sbyte) are aliases for build-in types (e.g. SByte)
			...
			variableList[slot] = new Variable(variable, i);
			VariableRegister(slot, variableList[slot].address);
			return Success;
		}
  ...
  public static int Execute(string script) {
    int ret = HDFqlPINVOKE.Execute(script);
    return ret;
  }
  ...
  public static readonly int BufferSize = HDFqlPINVOKE.BufferSize_get();
  ...
  public static readonly int Default = HDFqlPINVOKE.Default_get();
  ...
  public static readonly int HardLink = HDFqlPINVOKE.HardLink_get();
  ...
  public static readonly int NativeEndian = HDFqlPINVOKE.NativeEndian_get();
