...
public class HDFqlJNI {
  ...
  public final static native int execute(String jarg1);
  ...
  public final static native void variableRegister(int jarg1, int jarg2);
  ...
  public final static native void variableCreate(int jarg1, int jarg2);
  ...
  public final static native int variableGetLong(int jarg1, int jarg2);
